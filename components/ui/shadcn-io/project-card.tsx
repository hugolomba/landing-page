...
const ProjectCard = React.forwardRef<HTMLDivElement, ProjectCardProps>(
  (
    ...
    return (
      ...
      >
        {/* Card Image Section */}
        <div className="aspect-video overflow-hidd p-2">
          <img
            src={imgSrc}
            alt={title}
        ...
        <div className="flex flex-1 flex-col px-6 pb-4">
          <h3 className="text-xl font-bold transition-colors duration-300 group-hover:text-primary uppercase">
            {title}
          </h3>
          <p className="mt-3 flex-1 text-muted-foreground line-clamp-3">
            {description}
          </p>
